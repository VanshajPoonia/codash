...
const workflowData = [
  {
    title: "Select a plan",
    text: "Customer visits our website and selects the plan that fulfills the need.",
  },
  {
    title: "Make the Payment",
    text: "Go to the payment page and pay the amount according to your desired pack.",
  },
  {
    title: "Get the IDE url and password by the email",
    text: "The payment will get reviewed and you will receive you credentials via email within 30 minutes.",
  },
  {
    title: "Open the Url and Enjoy you IDE.",
    text: "Visit the url sent to you via email, enter the password and start using it. You can install it also if you want.",
  },
];
