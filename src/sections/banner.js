    ...
    <Box as="section" id="banner" sx={styles.banner}>
      <Container sx={styles.container}>
        ...
        <Image
          ...
          alt="logo image"
        />
        <Heading as="h2">Revolution is here, Codash is here!</Heading>
        Why to waste time in downloading and installing Code-Editors?
        <br /> Write, Compile, Sync and Share your code directly from your
        browser.
        <br />
        <br />
        <Image
